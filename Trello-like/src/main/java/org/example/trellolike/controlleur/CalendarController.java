...
public class CalendarController {
    /**
     * Projet associé à la vue Calendrier
     */
    private Projet projet;

    /**
     * Constructeur du controller de la vue Calendrier
    ...
    /**
     * Traite l'ouverture du détail d'une tâche
     * @param t la tâche dont on veut voir le détail
     */
